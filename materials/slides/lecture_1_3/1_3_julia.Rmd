...
.footnote[*Thanks, Chad, for pointing that out.]
...
<div align="center">
  <img src="figures/generic_codewarn_float.png" height=200>
  <img src="figures/generic_codewarn_int.png" height=200>
</div>
...
This is why Julia can achieve C speed: it compiles optmized code for each type and doesn't need to waste time "guessing" a variable's type
