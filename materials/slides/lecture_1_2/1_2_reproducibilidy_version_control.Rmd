...
**Push**: Send the changes you commited in the local repository to the remote repository (i.e. GitHub)
...
We'll wrap up looking at GitHub features then jump into coding with Julia

**Before next class, please:**

1. Send me your GitHub username and accept invitation
2. Follow the instructions from [Quant Econ Lecture 1](https://julia.quantecon.org/getting_started_julia/getting_started.html) to install Julia, Jupyter, and Visual Studio (VS) code on your laptop
3. Do a test run: go back to Example 2 from our previous lecture and solve the equilibrium price for $q^*=1.5$
  - Just copy & paste the code from slides 35 and 36 and change that `-2` in the first line for `-1.5`
