...
Pkg.activate(".")
Pkg.instantiate()
Pkg.add("ForwardDiff"); Pkg.add("Distributions"); Pkg.add("QuadGK")
```
...
function integrate_gauss(f, a, b, N)
    # This function get nodes and weights
    x, w = gauss(N, a, b)
...
2. **Numerical operations and representations** 
   ...
   3. **Function approximation** $\leftarrow$
3. Systems of equations
4. Optimization
5. Structural estimation
