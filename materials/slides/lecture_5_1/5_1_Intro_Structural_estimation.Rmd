...
We seen many tools that allows us to solve many of the well-defined problems in economics

By now, we can:

- Numerically calculate difficult integrals and derivatives
  - E.g.: we can calculate expectations of weird functions, evaluate FOCs and SOCs

--

- Solve linear and nonlinear systems
  - E.g.: we can solve for equilibria in single-agent and models
...
- Approximate unknown functions and solve functional equations
  - E.g.: we can interpolate between data points and solve for best-response functions

--

- Unconstrained and constrained optimization
  - E.g.: we can solve utility maximization and cost minimization problems
...
- It may also tell us about how $y$ relats to  *unobservable* variables $\xi$
...
Manipulating data in Julia with DataFrames
