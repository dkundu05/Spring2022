...
Firm i's profits: $\pi_i(q_1,q_2) = P(q_1 + q_2) - C_i(q_i)$
...
$$
\begin{align*}
f_1(q_1, q_2) & = (q_1 + q_2)^{-1/\eta} - (1/\eta)(q_1 + q_2)^{-1/\eta-1}q_1 - c_1 q_1 = 0 \\
f_2(q_1, q_2) & = (q_1 + q_2)^{-1/\eta} - (1/\eta)(q_1 + q_2)^{-1/\eta-1}q_2 - c_2 q_2 = 0
\end{align*}
$$
...
$f(q)$ will return a vector (pay attention to the use of the dot syntax)
...
$$
\begin{align*}
\frac{\partial f_{i}}{\partial q_{i}} &= (1/\eta)(q_{1}+q_{2})^{-1/\eta-1}\left[-2+(1/\eta+1)(q_{1}+q_{2})^{-1}q_{i}\right]-c_{i} \\
\frac{\partial f_{i}}{\partial q_{j\neq i}} &= \underbrace{(1/\eta)(q_{1}+q_{2})^{-1/\eta-1}}_{A} \left[1+ \underbrace{(1/\eta+1)(q_{1}+q_{2})^{-1}}_{B} q_{i}\right]
\end{align*}
$$
---
...
\end{bmatrix}
$$
where $A\equiv(1/\eta)(q_{1}+q_{2})^{-1/\eta-1}$, $B\equiv(1/\eta)(q_{1}+q_{2})^{-1}$
...
Let's test it out with initial guess $(1,2)$
